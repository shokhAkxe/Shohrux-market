...
function ContactPage() {
  ...
  const contacts = [
    { icon: MapPin, title: "Manzil", info: "Toshkent sh., Chilonzor tumani", color: "text-red-500", bg: "bg-red-50" },
    { icon: Phone, title: "Telefon", info: "+998 99 123 45 67", color: "text-green-500", bg: "bg-green-50" },
    { icon: Mail, title: "Email", info: "info@shohruxmarket.uz", color: "text-blue-500", bg: "bg-blue-50" },
    { icon: Clock, title: "Ish vaqti", info: "Dushanba - Shanba: 09:00 - 21:00", color: "text-orange-500", bg: "bg-orange-50" },
  ];

  const supportChannels = [
    { icon: Headphones, title: "24/7 Qo'llab-quvvatlash", desc: "Har doim yordamga tayyormiz", color: "bg-purple-500", link: "tel:+998991234567" },
    { icon: MessageCircle, title: "Telegram orqali", desc: "@shohrux_market_support", color: "bg-blue-500", link: "https://t.me/shohrux_market_support" },
    { icon: Globe, title: "Online chat", desc: "Sayt orqali jonli muloqot", color: "bg-green-500", link: "#" },
    { icon: Shield, title: "Sifat kafolati", desc: "100% original mahsulotlar", color: "bg-indigo-500", link: "#" },
  ];
    ...
    <div className="min-h-screen bg-slate-50 pt-16 sm:pt-20">
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-10 md:py-12">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">Biz bilan bog'lanish</h1>
          <p className="text-slate-500 text-sm sm:text-base">Savollaringiz bo'lsa, bizga yozing</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-5 sm:p-6 mb-8 text-white text-center">
          ...
          <h2 className="text-xl sm:text-2xl font-bold mb-2">24/7 Qo'llab-quvvatlash xizmati</h2>
          <p className="text-purple-100 text-sm sm:text-base">Har qanday vaqtda yordamga tayyormiz</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-sm">
              <h3 className="font-semibold text-sm sm:text-base mb-3">Biz ijtimoiy tarmoqlarda</h3>
          ...
          <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-sm">
            <h2 className="text-xl sm:text-2xl font-bold mb-4">Xabar yuborish</h2>
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              ...
              >
                {loading ? "Yuborilmoqda..." : <><Send size={16} className="sm:w-5 sm:h-5" /> Xabar yuborish</>}
              </button>
            </form>
          </div>
        </div>
        ...
        <div className="mt-6 sm:mt-8 bg-gradient-to-br from-slate-200 to-slate-300 rounded-2xl h-48 sm:h-56 md:h-64 flex items-center justify-center">
          <p className="text-slate-400 text-sm sm:text-base">📍 Google Map joylashuvi</p>
        </div>
      </div>
    </div>
  );
